...
/*   Updated: 2026/01/29 12:27:32 by kpires           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void AForm::beExecuted(const bool isSigned, const int exec_grade, const int gradeToExec) const{
    if(!isSigned)
        throw AForm::FormNotSignedExcept();
    if(exec_grade > gradeToExec)
        throw AForm::GradeTooLowExcept();
    return ;
}
